...
| :--- | :--- | :--- | :--- |
| **Identity & Access** | IAM Instance Profiles (No Static Keys) | [`phase1/01_iam_role_audit.json`](./phase1/01_iam_role_audit.json) | **PASS** |
| **Observability** | Custom Metrics ("Panic Button") | [`phase1/03_custom_metrics.json`](./phase1/03_custom_metrics.json) | **PASS** |
| **Edge Security** | Global WAFv2 & Origin Cloaking | [`phase2/01_waf_association.txt`](./phase2/01_waf_association.txt) | **PASS** |
| **Origin Cloaking** | ALB Ingress restricted to CloudFront | [`phase2/02_origin_handshake.json`](./phase2/02_origin_handshake.json) | **PASS** |
| **Data Residency** | RDS prohibited in Spoke region | [`phase3/01_data_residency_proof.json`](./phase3/01_data_residency_proof.json) | **PASS** |
| **Network Integrity** | Traffic traverses private TGW Corridor | [`phase3/02_tgw_peering_state.json`](./phase3/02_tgw_peering_state.json) | **PASS** |
...
[![Identity Proof](./Screenshots/phase1_instances_sts_and_ncat.png)](./Screenshots/phase1_instances_sts_and_ncat.png)
...
[![Secrets Rotation](./Screenshots/phase1_parameters_secrets_cwagent.png)](./Screenshots/phase1_parameters_secrets_cwagent.png)
...
[![VPC Endpoints](./Screenshots/phase1_vpcendpoints_sns.png)](./Screenshots/phase1_vpcendpoints_sns.png)
> **Exhibit 1.3:** *VPC Endpoints and SNS Topic configuration ensuring private connectivity without Internet Gateway reliance.*

---

### 🟢 Phase 2: Edge Security & Origin Cloaking
...
[![WAF Shield](./Screenshots/waf_association_handshake_proof_phase2.png)](./Screenshots/waf_association_handshake_proof_phase2.png)
...
*   **Static Assets:** [`03_cache_behavior_static.txt`](./phase2/03_cache_behavior_static.txt) showing `x-cache: Hit`.
*   **Dynamic API:** [`04_cache_behavior_api.txt`](./phase2/04_cache_behavior_api.txt) showing `x-cache: Miss` and `no-store`.

---

### 🟢 Phase 3: The "Japan Medical" Corridor
...
[![Corridor Success](./Screenshots/phase3_proofs_1.png)](./Screenshots/phase3_proofs_1.png)
...
alb_dns_name               = "armageddon-shinjuku-phase-3-alb-926071206.ap-northeast-1.elb.amazonaws.com"
cloudfront_distribution_id = "E1YO9AOVYWJV94"
cloudfront_url             = "https://phase3.couch2cloud.dev"
peering_id                 = "tgw-attach-03c5cb529155b1bd5"
rds_endpoint               = "phase-mysql.cx6qsskueoi7.ap-northeast-1.rds.amazonaws.com"
tgw_id                     = "tgw-0f75d1c62300ad055"
vpc_cidr                   = "172.17.0.0/16"
waf_web_acl_arn            = "arn:aws:wafv2:us-east-1:582600397173:global/webacl/armageddon-shinjuku-phase-3-waf/..."
```
[![Tokyo Output Proof](./Screenshots/shinjuku_outputs_phase3.png)](./Screenshots/shinjuku_outputs_phase3.png)
...
alb_dns_name            = "armageddon-liberdade-phase-3-alb-1693326215.sa-east-1.elb.amazonaws.com"
ec2_instance_id         = "asg-managed"
tgw_id                  = "tgw-0b75a4e4c0ce80b41"
vpc_cidr                = "172.18.0.0/16"
```
[![Sao Paulo Output Proof](./Screenshots/liberdade_outputs_phase3.png)](./Screenshots/liberdade_outputs_phase3.png)
